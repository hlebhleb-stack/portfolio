    ...
    cases: {
      'colb-finance': {
        ...
        content: {
          context: (
            <>
              {colbLink('Colb')} — швейцарская платформа для токенизированных pre-IPO инвестиций. Я пришёл туда единственным графическим и моушн-дизайнером — сначала вести визуал для соцсетей, но задача быстро выросла в моушн-видео, прототипы сайта, материалы для инвесторов и продуктовую документацию.
            </>
          ),
          motionVideosP1a:
          ...
          editorial:
            'С редакционной графикой иначе. У каждой свой визуальный подход в зависимости от темы контента. Цель — чтобы изображение несло смысл, а не просто обрамляло текст.',
          onePager:
          ...
          gitbook:
            'Визуальная система для продуктовой документации Colb. У каждого раздела своя графика при сохранении единства по всей книге. Главный вызов — перевести сложные финансовые концепции в визуал, который проясняет, а не просто украшает.',
          gitbookLink: 'docs.colb.finance',
          output:
